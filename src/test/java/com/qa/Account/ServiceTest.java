...
import com.qa.user.userapi.service.UserServiceImpl;
...
public class ServiceTest {
	...
	private static final Optional<User> MOCK_ACCOUNT_OPTIONAL = Optional.of(MOCK_ACCOUNT_1);
	private static final Optional<User> MOCK_NULL_OPTIONAL = Optional.empty();
